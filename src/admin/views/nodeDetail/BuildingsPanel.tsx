...
import { worldsApi, type BuildingInstance, type CreateBuildingBody } from '@/admin/lib/api/worlds';
import {
  type PatchField,
  unchanged,
  setTo,
...
import type { NodeId, WorldId } from '@/admin/lib/types';
